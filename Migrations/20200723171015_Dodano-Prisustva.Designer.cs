...
namespace Courses.Migrations
{
    ...
    [Migration("20200723171015_Dodano-Prisustva")]
    partial class DodanoPrisustva
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Courses.Models.Predavanje", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Courses.Models.Prisustvo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Courses.Models.Prisustvo", b =>
                {
                    b.HasOne("Courses.Models.KursKorisnik", "KursKorisnik")
                        .WithMany()
                        .HasForeignKey("KursKorisnikId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Courses.Models.Predavanje", "Predavanje")
                        .WithMany("Prisustva")
